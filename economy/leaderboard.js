...
`) 
  ...
  if(option.match ('balance') || option.match('bal')) {
      let board = [];
  ...
  let embed = new RichEmbed() 
  .setColor(color) 
  .setDescription(`**<:dollar:705795560363524166> | Top 10 Global Rich User\n\n**\`\`\`📋 Rank | Name\n\n${top}\`\`\``);
