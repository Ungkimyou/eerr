...
**${message.author.username}** used **<:dollar:705795560363524166> ${amount}** and won **<:dollar:705795560363524166> ${random}**
	`), 2300);
  }
      let curbal = bal[message.author.id].balance;
...
**${message.author.username}** used <:dollar:705795560363524166> **${amount}** and lost everything.
	`),2300)
  }
