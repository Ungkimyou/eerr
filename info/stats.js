...
//	.setDescription('\`\`\`A statistics monitoring module. Contains essential information regarding our service and bot information. Wrapped with beautiful Discord.js Interactive Library and RichEmbed amazing Constructor.\`\`\`')
	.addField('Owners', '\`\`\`• Ung KimYou\`\`\`')
//	.addField('Special thanks', '\`\`\`• 12042#5754\`\`\`') 
	...
	exports.conf = {
		aliases: ['about', 'info', 'botstats', 'botinfo'], 
		cooldown:' 5'
	} 
	exports.help = {
		name: 'stats', 
