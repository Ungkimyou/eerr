...
//  const guild = client.guilds.get('693357384181088317');
 // guild.channels.get('693855913139896340').setName(`Online : ${guild.members.filter(o => o.presence.status === 'online' || o.presence.status === 'idle' || o.presence.status === 'dnd').size}`)
