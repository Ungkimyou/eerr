...
module.exports.run = async (client, message, args) => {
  if (!message.guild.member(client.user).hasPermission('ATTACH_FILES')) return message.reply('Sorry, i dont have the perms to do this cmd i need ATTACH_FILES. :x:')
   ...
   const getSlapped = async (person) => {
    const plate = await Canvass.loadImage('https://cdn.discordapp.com/attachments/697137978321141821/703281644584435773/download.png');
...
module.exports.help = {
  ...
  usage: "tattoo <user>",
  example: ["tattoo <@356510829920780289>"]
};
