...
if(!args[0]) return message.channel.send("**Mention a user or users that you want to bond.** `PREFIX ship <user> <user>`")
...
exports.help = {
    name: "bond",
    description: "how many heart% are you with someone?",
    usage: "bond <user> or bond <user1> <user2>"
}
